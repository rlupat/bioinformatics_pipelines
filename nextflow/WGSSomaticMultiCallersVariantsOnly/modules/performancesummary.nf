...
process PERFORMANCESUMMARY {
    ...
    publishDir "${params.outdir}/performance_summary_tumor/performancesummary"
    ...
    script:
    def genome = params.performance_summary_tumor.performancesummary_genome == false ? "" : "--genome"
