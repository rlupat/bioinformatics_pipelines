...
process MARK_DUPLICATES {
    ...
    publishDir "${params.outdir}/alignment_tumor/merge_and_markdups/markduplicates"
    cpus "${params.alignment_tumor.merge_and_markdups.mark_duplicates.cpus}"
    memory "${params.alignment_tumor.merge_and_markdups.mark_duplicates.memory}"
