...
process VC_VARDICT_SORT_COMBINED {
    debug true
    container "biocontainers/bcftools@sha256:ab5e68068ff56baf59b79f995b5425edba9f61cc86a5476357db87ec2670899d"
    publishDir "${params.outdir}/vc_vardict_sort_combined"
    cpus "${params.vc_vardict_sort_combined.cpus}"
    memory "${params.vc_vardict_sort_combined.memory}"
