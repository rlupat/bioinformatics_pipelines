...
process GATK4COLLECTINSERTSIZEMETRICS {
    ...
    publishDir "${params.outdir}/performance_summary_tumor/gatk4collectinsertsizemetrics"
    cpus "${params.performance_summary_tumor.gatk4collectinsertsizemetrics.cpus}"
    memory "${params.performance_summary_tumor.gatk4collectinsertsizemetrics.memory}"
