...
process SORTSAM {
    ...
    def create_index = params.align_and_sort.sortsam_create_index == false ? "" : "--CREATE_INDEX"
    def java_options = null
    def max_records_in_ram = params.align_and_sort.sortsam_max_records_in_ram ? "--MAX_RECORDS_IN_RAM ${params.align_and_sort.sortsam_max_records_in_ram}" : ""
    def tmp_dir = tmp_dir ? tmp_dir : /tmp/
    def validation_stringency = params.align_and_sort.sortsam_validation_stringency ? "--VALIDATION_STRINGENCY ${params.align_and_sort.sortsam_validation_stringency}" : ""
    """
    gatk SortSam \
